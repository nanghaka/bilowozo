...
<div class="breadcrumb">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Home</a> &gt; <a href="users.php">All Users</a> &gt; Profile of a user
    </div>
	<div class="box_right">
...
{
?>
<br /><div class="center"><a href="edit_profile.php" class="btn btn-default">Edit my profile</a></div>
<?php
}
?>
...
?></td>
    ...
    <!--	Email: <?php //echo htmlentities($dnn['email'], ENT_QUOTES, 'UTF-8'); ?><br /> -->
        This user joined the Speak Your Mind on <?php echo date('Y/m/d',$dnn['signup_date']); ?></td>
    </tr>
</table>
<?php
